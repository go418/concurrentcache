...
type versionedValue[V any] struct {
	value   V
	err     error
	version versionsinternal.CacheVersion
}
...
func (vv versionedValue[V]) newer() CacheVersion {
	return versionsinternal.NextVersion(vv.version)
}
...
type cacheWorker[V any] struct {
	// 'returnValue' is a copy of the value that was generated by the worker. It
